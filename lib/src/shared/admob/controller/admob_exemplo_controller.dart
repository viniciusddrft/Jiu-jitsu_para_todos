...
class AdmobController {
  ...
  static String get nativeAdUnitIDListTile => '';
...
//Used to load ads into didChangeDependencies to optimize
  static void createInterstitialAd() => InterstitialAd.load(
  ...
  static void _createAndShowInterstitialAd() => InterstitialAd.load(
        adUnitId: _interstitialAdUnitID,
        request: const AdRequest(),
        adLoadCallback: InterstitialAdLoadCallback(
          onAdLoaded: (InterstitialAd ad) {
